...
class Test_SafetyRequirements(WebDriverSetup):
    def test_editsSafetyReq(self):
        ...
        EditDetailsPage(self.driver).edit_safety_requirements(self.file,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam eleifend faucibus risus non pellentesque. '
