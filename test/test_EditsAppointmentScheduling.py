...
class Test_AppointmentScheduling(WebDriverSetup):
    def test_editsAppointment(self):
        ...
        EditDetailsPage(self.driver).edit_appointment_scheduling('www.testing.com', 'alan', '@hotmail.com', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam eleifend faucibus risus non pellentesque. '
                                                                                                            ...
                                                                                                            'maximus neque neque, sit amet commodo nunc malesuada ut.', self.file)
